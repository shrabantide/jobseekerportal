<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMaster.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="JobSeekerPortal.Employee.ChangePassword" %>
     ...
     <div style="background-color:whitesmoke; height:650px; width:500px; font-family:'Times New Roman'; margin-left:550px ">
           ...
           <br />
            ...
            <br /><br />
             ...
             <asp:Button ID="btnemp" runat="server" CssClass="button button2" Font-Bold="true" Font-Size="Large" Text="Change Password"  style="margin-top:10px " OnClick="btnemp_Click" />
         <br />
