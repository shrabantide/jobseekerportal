<%@ Page Title="" Language="C#" MasterPageFile="~/HRmaster.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="JobSeekerPortal.HR.ChangePassword" %>
     ...
     <div style="background-color:whitesmoke; height:650px; width:500px; font-family:'Times New Roman'; margin-left:550px ">
           ...
           <br />
            ...
            <br /><br />
             ...
             <asp:Button ID="btnhr" runat="server" CssClass="button button2" Font-Bold="true" Font-Size="Large" Text="Change Password"  style="margin-top:10px " OnClick="btnhr_Click" />
         <br />
