<%@ Page Title="" Language="C#" MasterPageFile="~/HRmaster.Master" AutoEventWireup="true" CodeBehind="ManageProfile.aspx.cs" Inherits="JobSeekerPortal.HR.ManageProfile" %>
  ...
  color: white;
    ...
    <form runat="server">
     <div style="background-color:whitesmoke; height:500px; width:500px; margin-left:500px; font-family:'Times New Roman' ">
         <br /><br />
            ...
            <div style="margin-left:0px; margin-top:10px; font-family: Courier New, Courier, monospace;">
                ...
                <tr>
                    <td>
                            <div style=" font-family: Courier New, Courier, monospace;">
                <asp:Label ID="lblcompanyname" runat="server" Text="Enter Company Name" Font-Bold="true"></asp:Label>
                &nbsp; &nbsp;
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtcname" ForeColor="Red" ErrorMessage="*" style="margin-left : -30px"></asp:RequiredFieldValidator>
                &nbsp; &nbsp;
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtcname" ForeColor="Red" ErrorMessage="Invalid format" ValidationExpression="[A-Za-z0-9 ]{1,50}"></asp:RegularExpressionValidator>
              
                <br />
            </div>
            <div style="margin-left:0px; margin-top:10px; font-family: Courier New, Courier, monospace;">
                <asp:TextBox ID="txtcname" runat="server" style=" width: 300px; height: 40px;  border-radius: 5px; padding-left: 8px;"></asp:TextBox>
            </div>
                    </td>
            ...
            <div style="font-family: Courier New, Courier, monospace;" >
              ...
              &nbsp;
                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtaddress" ForeColor="Red" ErrorMessage="Invalid format" ValidationExpression=".{3,250}"></asp:RegularExpressionValidator>
        ...
        <br />
             <asp:Button ID="btnprofile" runat="server" CssClass="button button2" Font-Bold="true" Font-Size="Large" Text="Submit" style="margin-top:-20px; margin-left:-70px" OnClick="btnprofile_Click" />
            <br />
