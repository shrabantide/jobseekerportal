<%@ Page Title="" Language="C#" MasterPageFile="~/Adminmaster.Master" AutoEventWireup="true" CodeBehind="Report_ViewHRs.aspx.cs" Inherits="JobSeekerPortal.Admin.Report_ViewHRs" %>
  ...
  color: black;
    ...
    <form runat="server">
        <asp:Panel ID="pn" runat="server">
            <center>
                  <asp:Label ID="lblhead" runat="server" Font-Bold="true" Font-Size="Larger" Text="HR List" style="margin-left : 150px"></asp:Label>
