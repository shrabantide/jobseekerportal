<%@ Page Title="" Language="C#" MasterPageFile="~/Adminmaster.Master" AutoEventWireup="true" CodeBehind="Report_ViewAppliedEmployees.aspx.cs" Inherits="JobSeekerPortal.Admin.Report_ViewAppliedEmployees" %>
  ...
  color: black;
    ...
    <form runat="server">
        <asp:Panel ID="pn" runat="server">
             <center>
                  <asp:Label ID="lblhead" runat="server" Font-Bold="true" Font-Size="Larger" Text="Applied Employees List" style="margin-left : 150px"></asp:Label>
