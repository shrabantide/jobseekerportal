<%@ Page Title="" Language="C#" MasterPageFile="~/Adminmaster.Master" AutoEventWireup="true" CodeBehind="ViewAppliedEmployees.aspx.cs" Inherits="JobSeekerPortal.Admin.ViewAppliedEmployees" %>
...
.button2:hover {
  ...
  color: black;
    ...
    <form runat="server">
        <center>
                  <asp:Label ID="lblhead" runat="server" Font-Bold="true" Font-Size="Larger" Text="Applied Employees" style="margin-left : 150px"></asp:Label>
