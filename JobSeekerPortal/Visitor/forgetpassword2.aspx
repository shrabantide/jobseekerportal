<%@ Page Title="" Language="C#" MasterPageFile="~/VisitorMaster.Master" AutoEventWireup="true" CodeBehind="forgetpassword2.aspx.cs" Inherits="JobSeekerPortal.Visitor.forgetpassword2" %>
  ...
  color: white;
    ...
    <center>
        <div style="background-color:whitesmoke; height:400px; width:500px; font-family:'Times New Roman' ">
            <asp:Label ID="label1" runat="server" Text="FORGET PASSWORD OTP VERIFICATION" BorderWidth="40px" BorderColor="WhiteSmoke" Font-Size="40px" Font-Bold="true"></asp:Label>
            ...
            <br /><br />
             ...
             <asp:Button ID="btnotpverify" runat="server" CssClass="button button2" Font-Bold="true" Font-Size="Large" Text="Verify OTP"  style="margin-top:10px" OnClick="btnotpverify_Click"/><br />
